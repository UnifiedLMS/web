...
import { Calendar, Table2, Settings } from "lucide-react";
...
export default function TeacherHome() {
  const features = [
    {
      title: "Розклад",
      description: "Переглядайте та редагуйте розклад занять, теми та домашні завдання",
      icon: Calendar,
      link: "/teacher/schedule",
    },
    {
      title: "Оцінювання",
      description: "Виставляйте оцінки студентам за групами та дисциплінами",
      icon: Table2,
      link: "/teacher/grades",
    },
    {
