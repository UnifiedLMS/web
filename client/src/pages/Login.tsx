...
import { Chrome, Eye, EyeOff, Loader2, ClipboardPaste, CheckCircle2 } from "lucide-react";
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="relative py-2">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-transparent px-3 text-xs uppercase tracking-wide text-white/30">або</span>
                  </div>
                </div>
